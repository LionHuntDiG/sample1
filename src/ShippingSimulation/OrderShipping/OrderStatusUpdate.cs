...
namespace OrderShipping
{
    public partial class Shipping : Form
    {
        ...
        const string ServiceBusConnectionString = "Endpoint=sb://msservice.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=nY0ruLL4seKUbhVBguL4Sw1pqY5m/QW+ZsdeXauZAXY=";
